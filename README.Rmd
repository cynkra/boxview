...
There's also a `width` argument to adjust, and an `optimization` argument that
you might use to get a nicer output, at the cost of taking more time.

![](inst/ave.png)

## See also

The [flow](https://github.com/moodymudskipper/flow) package and in particular the 
function `flow::flow_view()` for a somewhat comparable way to represent functions.
